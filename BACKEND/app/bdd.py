...
coneccion="mysql+mysqlconnector://root:Karlo123%40@localhost:3306/probando" 
...
"""
from flask_sqlalchemy import SQLAlchemy
coneccion="mysql+mysqlconnector://root:ADC@localhost:3306/probando" 
coneccion_inventario = coneccion.replace("probando", "desarrollo")
db = SQLAlchemy()
"""